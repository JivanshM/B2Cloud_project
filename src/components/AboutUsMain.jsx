      ...
      >
        ...
        >
          <h1 style={{ fontSize: "2.5em" }}>
            Ready to take{" "}
            <span style={{ color: "#00ff00" }}>your business</span> to the next
            level?
          </h1>
          <p style={{ color: "white" }}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et ut massa
            libero egestas malesuada vivamus gravida libero cursus nulla leo
            pulvinar. Lorem, ipsum dolor sit amet consectetur adipisicing elit.
            Eos quae iure blanditiis voluptatem cum ratione nesciunt illum
            dignissimos quas iusto et inventore non delectus, nulla minima
            asperiores. Numquam veritatis nemo dolorem illum tenetur in error
            harum excepturi eum, ex, reprehenderit expedita fugit ea placeat
            architecto pariatur laudantium velit debitis facere!
          </p>
          <div
        ...
        <div
          ...
          style={{ flex: "1 1 60%", position: "relative" }}
        >
          <img
